...
```javascript
pkg2id = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/error-tools-pkg2id@v0.0.2-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/error-tools-pkg2id@v0.0.2-umd/browser.js"></script>
```
